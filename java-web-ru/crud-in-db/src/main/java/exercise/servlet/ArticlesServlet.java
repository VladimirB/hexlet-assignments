...
public class ArticlesServlet extends HttpServlet {
    ...
    private void createArticle(HttpServletRequest request,
        ...
        try {
            ...
            System.out.println("CREATE ARTICLE: result is " + result);
        } catch (SQLException e) {
            e.printStackTrace();
            response.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
            return;
    ...
    private void updateArticle(HttpServletRequest request,
        ...
        try {
            ...
            System.out.println("UPDATE ARTICLE: result is" + result);
        } catch (SQLException e) {
            e.printStackTrace();
            response.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
            return;
    ...
    private void destroyArticle(HttpServletRequest request,
        ...
        try {
            ...
            boolean result = statement.execute();
            System.out.println("DESTROY ARTICLE: result is " + result);
        } catch (SQLException e) {
            e.printStackTrace();
            response.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
            return;
